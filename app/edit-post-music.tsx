...
/**
 * Man hinh chon nhac khi chinh sua bai viet.
 * @returns JSX Element
 */
export default function EditPostMusicScreen() {
  ...
  const initialMusicId =
    typeof params.selectedMusicId === "string" && params.selectedMusicId.length > 0
  ...
  const [selectedMusicId, setSelectedMusicId] = useState<string | null>(initialMusicId);
  ...
  /**
   * Chuyen sang buoc chinh sua noi dung bai viet.
   * @returns void
   */
    ...
    <SafeAreaView style={styles.container} edges={["top", "bottom"]}>
      <View style={styles.header}>
        <View style={styles.headerLeft}>
          <BackButton href="/post-edit/image" />
        </View>
